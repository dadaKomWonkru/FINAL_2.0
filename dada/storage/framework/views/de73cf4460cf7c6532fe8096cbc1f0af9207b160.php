        ...
        <div  class="mt-8 bg-white dark:bg-gray-800 overflow-hidden shadow sm:rounded-lg">
            <div class="ml-4 text-lg leading-7 font-semibold">
                <a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white">
                    <?php echo e($book->id); ?>.<?php echo e($book->title); ?></a>
            </div>
            <form method="book" action="<?php echo e(route("book.delete",$book->id)); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\Dada\Desktop\dada\resources\views/books.blade.php ENDPATH**/ ?>