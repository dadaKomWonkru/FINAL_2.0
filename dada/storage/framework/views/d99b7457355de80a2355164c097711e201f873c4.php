            ...
            <div class="grid grid-cols-1 md:grid-cols-2">
                <div class="p-6">
                    <div class="flex items-center">
                        ...
                        <div class="ml-4 text-lg leading-7 font-semibold"><a href="https://laravel.com/docs" class="underline text-gray-900 dark:text-white"><?php echo e($book->id); ?>.<?php echo e($book->title); ?></a></div>
                    </div>

                    <div class="ml-12">
                        <div class="mt-2 text-gray-600 dark:text-gray-400 text-sm">
                            <?php echo e($book->author); ?>-<?php echo e($book->language); ?>-<?php echo e($book->pages); ?> pages
                        </div>
                    </div>
                </div>
            </div>
...
<?php /**PATH C:\Users\Dada\Desktop\dada\resources\views/book.blade.php ENDPATH**/ ?>