...
<body class="antialiased">
    ...
    <div>
        <form  method="post" enctype="multipart/form-data" action="<?php echo e(route('book.save')); ?>">
            <div class="box-body">
...
<?php /**PATH C:\Users\Dada\Desktop\dada\resources\views/create.blade.php ENDPATH**/ ?>